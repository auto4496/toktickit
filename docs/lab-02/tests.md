...
| UI-10 | UI | FR-22-FR-27, FR-32, AC-13-AC-19, AC-24 | Attachment active, uploading, unsafe/invalid, failed, removed, no-preview, and unexpected-failure states | Correct controls, no Preview action, reason dialog, retained metadata, blocked removed access, safe error, and Retry where meaningful | `client/tests/lab-02/AttachmentSection.test.tsx` | Planned |
